...
{  
  ...
  private:
    ...
    static Repository* instance;	//puts it own address in the instance object
	//because of this any file that includes #include ActionsAndRules, can get to Repository
  ...
  public:
    ...
    Repository(Scanner::Toker* pToker) : ast(stack)
    {
      ...
      instance = this;		//points to the object pointer instance
    }
