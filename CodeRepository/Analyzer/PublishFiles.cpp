#pragma once
/////////////////////////////////////////////////////////////////////
// PublishFiles.cpp - Creates a Code Publisher			            //
// ver 1.0                                                         //  
//								     							   //
...
int main()
{
	...
	PublishFiles p(exec.temp); //create an object for publishing the files
...
void PublishFiles::createStyleSheet()
{
...
void PublishFiles::createJavaScript()
{
...
void PublishFiles::publishAllFiles()
{
...
//generates the html files of all the files in the dependency table and stores them in a directory
 void PublishFiles::toHtm(string filepath) {
	string filename = "";
